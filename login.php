...
<ul id="Breadcrumb3">
<li class="active" aria-current="page"><i class="fa fa-address-card-o">&nbsp;</i>&nbsp; Login &amp; sign in</li>
</ul>
...
<div id="Html1" style="display:inline-block;width:100px;height:100px;z-index:2">
</div>
</div>
...
<div class="row">
<div class="col-1">
<div id="wb_Heading10" style="display:inline-block;width:100%;z-index:3;">
...
<div id="wb_CssMenu3" style="display:inline-block;width:100%;z-index:6;">
<ul role="menubar">
...
<div id="wb_CssMenu2" style="display:inline-block;width:100%;z-index:8;">
<ul role="menubar">
...
<div id="wb_Shape1" style="display:inline-block;width:100px;height:39px;z-index:10;position:relative;">
<a href="./Donat.php"><img src="images/img0002.png" id="Shape1" alt="" style="width:100px;height:39px;"></a>
</div>
</div>
</div>
</div>
